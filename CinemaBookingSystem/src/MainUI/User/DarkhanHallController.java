...
public class  DarkhanHallController implements Initializable {
    ...
    public void BookParticularSeat() {
        ...
        String sqlInsert = "INSERT INTO `Members5Hall` (`Name`,`Surname`,`ContactNumber`,`CreditCardNumber`,`seatID`,'MovieName') VALUES (?,?,?,?,?,?)";

        //setting status to not free
        String sqlUpdateRoom = "UPDATE DarkhanHall SET Available = ? WHERE Number = ?";
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        String sqlCheckWhichIsFree = "SELECT Name, Surname, SeatID FROM Members5Hall";
        ...
        try { //try block
            ...
            String sqlUpdateSeats = "UPDATE DarkhanHall SET Available = ? WHERE Number = ?";
            ...
            String sqlGetFree = "SELECT Number, Available FROM DarkhanHall";
