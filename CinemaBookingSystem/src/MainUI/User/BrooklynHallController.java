...
import java.util.regex.Pattern;
    ...
    public class  BrooklynHallController implements Initializable {
        ...
        public void BookParticularSeat() {
            ...
            String sqlInsert = "INSERT INTO `Members3Hall` (`Name`,`Surname`,`ContactNumber`,`CreditCardNumber`,`seatID`,`MovieName`) VALUES (?,?,?,?,?,?)";

            //setting status to not free
            String sqlUpdateRoom = "UPDATE BrooklynHall SET Available = ? WHERE Number = ?";
        ...
        public void initialize(URL location, ResourceBundle resources) {
            ...
            String sqlCheckWhichIsFree = "SELECT Name, Surname, SeatID FROM Members3Hall";
            ...
            try { //try block
                ...
                String sqlUpdateSeats = "UPDATE BrooklynHall SET Available = ? WHERE Number = ?";
                PreparedStatement statementUpdate = connection.prepareStatement(sqlUpdateSeats);

                //Find all busyseats and update them to no
                ...
                String sqlGetFree = "SELECT Number, Available FROM BrooklynHall";
