...
public class  LibertyHallController implements Initializable {
    ...
    public void BookParticularSeat() {
        ...
        String sqlInsert = "INSERT INTO `Members4Hall` (`Name`,`Surname`,`ContactNumber`,`CreditCardNumber`,`seatID`,`MovieName`) VALUES (?,?,?,?,?,?)";

        //setting status to not free
        String sqlUpdateRoom = "UPDATE LibertyHall SET Available = ? WHERE Number = ?";
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        String sqlCheckWhichIsFree = "SELECT Name, Surname, SeatID FROM Members4Hall";
        ...
        try { //try block
            ...
            String sqlUpdateSeats = "UPDATE LibertyHall SET Available = ? WHERE Number = ?";
            ...
            String sqlGetFree = "SELECT Number, Available FROM LibertyHall";
