...
import java.util.regex.Pattern;
    ...
    public class ComfortHallController implements Initializable {
        ...
        public void BookParticularSeat() {
            ...
            String sqlInsert = "INSERT INTO `Members2Hall` (`Name`,`Surname`,`ContactNumber`,`CreditCardNumber`,`seatID`,`MovieName`) VALUES (?,?,?,?,?,?)";

            //setting status to not free
            String sqlUpdateRoom = "UPDATE ComfortHall SET Available = ? WHERE Number = ?";
        ...
        public void initialize(URL location, ResourceBundle resources) {
            ...
            String sqlCheckWhichIsFree = "SELECT Name, Surname, SeatID FROM Members2Hall";
            ...
            try { //try block
                ...
                String sqlUpdateSeats = "UPDATE ComfortHall SET Available = ? WHERE Number = ?";
                ...
                String sqlGetFree = "SELECT Number, Available FROM ComfortHall";
